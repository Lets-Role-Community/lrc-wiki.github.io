Les colonnes/''column'' devraient '''toujours''' être placées dans les composants [[Row]]. Retrouvez plus d’informations à propos des colonnes ici : https://getbootstrap.com/docs/4.5/layout/grid/
